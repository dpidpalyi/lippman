...
int main() {
	...
	const int &r2 = 100;
	std::cout << "got: " << r2 << ", want: error" << std::endl; // Ha-ha second time
	const int &r3 = r1 * 2;
	std::cout << "got: " << r3 << ", want: error" << std::endl; // Ha-ha third time
	const int &rd = d; // d = 3.14
	std::cout << "got: " << rd << ", want: error" << std::endl; // Ha-ha fourth time
	d = 12345.6789;
