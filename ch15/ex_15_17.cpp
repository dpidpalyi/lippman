...
int main() {
	...
	//Disc_quote d("Disc", 2.5, 4, 0.5);
	/* ex_15_17.cpp:93:13: error: cannot declare variable ‘d’ to be of abstract type ‘Disc_quote’
   93 |  Disc_quote d("Disc", 2.5, 4, 0.5);
      |             ^
ex_15_17.cpp:22:7: note:   because the following virtual functions are pure within ‘Disc_quote’:
   22 | class Disc_quote : public Quote {
      |       ^~~~~~~~~~
ex_15_17.cpp:26:10: note: 	‘virtual double Disc_quote::net_price(std::size_t) const’
   26 |   double net_price(std::size_t) const = 0; // pure virtual
      |          ^~~~~~~~~
        */
